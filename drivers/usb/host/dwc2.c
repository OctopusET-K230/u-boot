				   ...
				   struct dwc2_core_regs *regs)
{
	...
	if (readl(&regs->gintsts) & DWC2_GINTSTS_CURMODE_HOST) {
        ...
        u32 usb_test_ctl3 = readl((regs == 0x91500000)?(const volatile void *)USB0_TEST_CTL3:(const volatile void *)USB1_TEST_CTL3);
        usb_test_ctl3 |= (USB_DMPULLDOWN0 | USB_DPPULLDOWN0);
        writel(usb_test_ctl3, (regs == 0x91500000)?(volatile void *)USB0_TEST_CTL3:(volatile void *)USB1_TEST_CTL3);
	}
...
static int dwc2_usb_probe(struct udevice *dev)
{
	...
	writel(0x1, (volatile void *)0x91108030);
